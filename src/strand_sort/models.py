...
class DietaryFlags(BaseModel):
    ...
    is_vegan: bool = False
    source: Literal["printed_claim", "inferred"] = "inferred"
...
class DonationItem(BaseModel):
    ...
    category: str = Field(..., description="One of: Canned Protein, Canned Soups/Veg, Grains/Pasta, Baby Food, Beverages, Boxed Meals")
